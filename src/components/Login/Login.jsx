...
import { Mail, Lock, Eye, EyeOff, Facebook, Fish, Droplets, KeyRound, Instagram, Twitter } from 'lucide-react';
            ...
            <Row className="g-0 h-100">
                ...
                <Col md={7} lg={6} className="d-flex align-items-center justify-content-center bg-light">
                    <div style={{ maxWidth: '450px', width: '100%', padding: '2rem' }}>
                        ...
                        <p className="text-muted mb-4">Đăng nhập để tiếp tục với Thủy Sinh Xanh.</p>

                        <Form>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Label>Email</Form.Label>
                                <InputGroup>
                                    <Form.Control type="email" placeholder="Nhập email của bạn" className="border-end-0" />
                            ...
                            <div className="d-flex justify-content-end mb-4">
                                <Link to="/forgot-password" size="sm" className="text-decoration-none small">Quên mật khẩu?</Link>
                            </div>
