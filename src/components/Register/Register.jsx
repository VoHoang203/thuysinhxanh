...
import { useAuth } from "../../context/app.context"; // <-- Đường dẫn context
import {
  Container,
  Row,
  Col,
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Lỗi khi đăng ký. Email có thể đã tồn tại.");
      console.log(err);
    }
  };
        ...
        >
          <div style={{ maxWidth: "450px", width: "100%", padding: "2rem" }}>
            ...
            <p className="text-muted mb-4">
              Tham gia cộng đồng yêu thủy sinh của chúng tôi.
            </p>
            ...
            >
              <Card.Body className="d-flex align-items-center p-4">
                ...
                <div>
                  ...
                  <p className="mb-0 small opacity-75">
                    Thông tin của bạn luôn được bảo vệ an toàn.
                  </p>
                </div>
              </Card.Body>
            </Card>
